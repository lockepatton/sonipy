...
![A type Ia supernova lightcurve.\label{fig:Ia}](./images/Ia.png) ![A type IIb supernova lightcurve.\label{fig:IIb}](./images/IIb.png)
...
![An eclipsing stellar binary.\label{fig:EB}](./images/EB.png) ![A variable star, phased over its period.\label{fig:RRLyrae}](./images/RRLyrae.png)
